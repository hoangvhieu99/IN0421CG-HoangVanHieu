...
SELECT a.*
FROM NHANVIEN a inner join hopdong as b on  a.idnhanvien=b.idnhanvien
where b.ngaylamhopdong='2019/12/12' and a.diachi='Hải Châu';
...
where diachi like "%Quảng Trị%" and sdt like "%0908888%";

CREATE UNIQUE INDEX IX_SoDT_DiaChi
ON khachhang (diachi, sdt);

EXPLAIN select * from khachhang
where diachi like "%Quảng Trị%" and sdt like "%0906666%";
...
END 
//  DELIMITER 
call Sp_2(004,1002,102,2,'2015/01/01','2019/12/31',30000000,120000000)
